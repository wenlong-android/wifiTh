...
public class OkChatTimeUtils {
    ...
    public static List<String> getDayList() {
        ...
        try {
            String startTime = getLastYear();
            String endTime = getToday();
            ...
            while (tempStart.before(tempEnd)) {
                ...
                //MjLog.print("获取日期列表:"+dateFormat.format(tempStart.getTime()));
    ...
    public static String getDateUnderLine(long s) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date date = new Date(s);
        String str=simpleDateFormat.format(date);
        String arr[]=str.split(" ");
        String arrObj1[]=arr[0].split("-");
        String arrObj2[]=arr[1].split(":");
        return arrObj1[0]+"年"+arrObj1[1]+"月"+arrObj1[2]+"日"+arrObj2[0]+"时"+arrObj2[1]+"分"+arrObj2[2]+"秒";

    }



    public static String getShortDate(long s) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date date = new Date(s);
        return simpleDateFormat.format(date);
